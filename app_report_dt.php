  ...
  <div class="wrapper">
    ...
    <div id="content" class="bg-container">
      ...
      <div class="outer container">
        ...
        <table id="server-report" class="table table-striped table-bordered" cellspacing="0" width="95%" style="display:block; overflow-x:auto; white-space:nowrap">
